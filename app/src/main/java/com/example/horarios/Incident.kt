...
import com.example.horarios.Constants.Companion.MINIMUM_SENIORITY_FREE_RETARDANT
import com.example.horarios.Constants.Companion.NUMBER_OF_RETARDANT_EQUIVALENT_TO_ONE_ABSENCE
import java.time.LocalDate

data class Incident (val employee: Employe,
